...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (hero) {
    gsap.from('.hero__badge', { opacity: 0, y: 30, duration: 0.5, delay: 0 });
    gsap.from('.hero__title', { opacity: 0, y: 50, duration: 0.7, delay: 0 });
    gsap.from('.hero__subtitle', { opacity: 0, y: 30, duration: 0.5, delay: 0 });
    ...
    gsap.from('.hero__stat', { opacity: 0, scale: 0.5, stagger: 0.1, duration: 0.5, delay: 0.4, ease: 'back.out(1.7)' });
    gsap.from('.hero__scroll', { opacity: 0, duration: 0.5, delay: 0.5 });

    gsap.to('.hero__scroll', { y: 12, duration: 1, ease: 'sine.inOut', repeat: -1, yoyo: true, delay: 0.8 });
  ...
  if (document.querySelector('.page-hero')) {
    gsap.from('.page-hero__label', { opacity: 0, x: -30, duration: 0.4, delay: 0.1 });
    gsap.from('.page-hero__title', { opacity: 0, y: 40, duration: 0.5, delay: 0.3 });
    gsap.from('.page-hero__subtitle', { opacity: 0, y: 20, duration: 0.4, delay: 0.2 });
  }

  // === CAR HERO ===
  if (document.querySelector('.car-hero')) {
    gsap.from('.breadcrumbs', { opacity: 0, x: -20, duration: 0.3, delay: 0.1 });
    gsap.from('.car-hero__main', { opacity: 0, scale: 0.95, duration: 0.3, delay: 0.2 });
    gsap.from('.car-hero__colors', { opacity: 0, y: 20, duration: 0.3, delay: 0.2 });
    gsap.from('.car-hero__brand', { opacity: 0, y: 15, duration: 0.2, delay: 0.2 });
    gsap.from('.car-hero__title', { opacity: 0, y: 25, duration: 0.3, delay: 0.2 });
    gsap.from('.car-hero__price', { opacity: 0, y: 20, duration: 0.3, delay: 0.2 });
    gsap.from('.car-hero__spec', { opacity: 0, y: 15, stagger: 0.08, duration: 0.2, delay: 0.3 });
  ...
  if (document.querySelector('.footer__grid')) {
    gsap.from('.footer__grid > *', {
      opacity: 0, y: 30, stagger: 0.1, duration: 0.2,
  ...
  if (document.querySelector('.cta')) {
    gsap.from('.cta__content > *', {
      opacity: 0, y: 30, stagger: 0.1, duration: 0.3,
  ...
  if (!isTouch) {
    ...
    document.querySelectorAll('.car-card').forEach(card => {
      card.addEventListener('mouseenter', () => gsap.to(card, { y: -10, duration: 0.2 }));
    ...
    document.querySelectorAll('.benefit').forEach(el => {
      el.addEventListener('mousemove', e => {
        ...
        gsap.to(el, { rotateY: x * 10, rotateX: -y * 10, duration: 0.2 });
      });
      el.addEventListener('mouseleave', () => {
        gsap.to(el, { rotateY: 0, rotateX: 0, duration: 0.3 });
      });
    });
    ...
    const observer = new MutationObserver(mutations => {
      mutations.forEach(m => {
        if (m.attributeName === 'class' && modal.classList.contains('active')) {
          gsap.from('.modal__content', { opacity: 0, scale: 0.9, y: 30, duration: 0.2, ease: 'back.out(1.7)' });
        }
      });
    });
